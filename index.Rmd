...
```
Plot 1 illustrates that most of the police killings in 2015 took place in the states which has a rate of hate crimes per 100k population of 0-0.4 and an average annual hate crime cases number per 100k population of 0-4.5.

```{R}
hcrimes_pkillings2 %>% ggplot(aes(x = state, fill=number_of_cases))+geom_bar()+theme_bw()+xlab("State")+ylab("Number of Police Killing Cases")+ggtitle("Number of Police Killing Cases Vary by States in 2015")
```
Plot 2 is a bar graph that illustrates the number of cases of police killings for each state in the United States in 2015. 

```{R}
ggplot(hcrimes_pkillings2, aes(x = raceethnicity, y = college, fill=gender))+
    geom_bar(stat="summary", position="dodge")+
    geom_errorbar(stat="summary",position="dodge")+xlab("Race/Ethnicity")+ylab("Share of 25+ Population with BA or Higher")+ggtitle("Demographic Information on the People Killed by Police in 2015(a)")+ylim(0, 1)+theme_bw() 

ggplot(hcrimes_pkillings2, aes(x = raceethnicity, y = share_pop_hs, fill=gender))+
    geom_bar(stat="summary", position="dodge")+
    geom_errorbar(stat="summary",position="dodge")+xlab("Race/Ethnicity")+ylab("Share of 25+ Population with a High-School Degree")+ggtitle("Demographic Information on the People Killed by Police in 2015(b)")+ylim(0, 1)+theme_bw() 
